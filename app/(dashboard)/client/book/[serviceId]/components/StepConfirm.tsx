        ...
        <div className="space-y-8 animate-fade-in">
            ...
            <div className="bg-neutral-50 rounded-2xl p-6 border border-neutral-200 space-y-6">
                ...
                <div className="flex justify-between items-start pb-4 border-b border-neutral-200">
                    <div>
                        <h3 className="font-semibold text-neutral-500 text-sm mb-1">Servicio</h3>
                        <p className="font-playfair text-xl font-bold text-primary-800">{service.name}</p>
                        <p className="text-sm text-neutral-600">{service.duration_minutes} min</p>
                    </div>
                ...
                <div className="pb-4 border-b border-neutral-200">
                    <h3 className="font-semibold text-neutral-500 text-sm mb-2">Profesional</h3>
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <p className="font-semibold text-primary-800">{employee?.name || 'Cualquiera'}</p>
                ...
                {/* Fecha y Hora */}
                <div>
                    <h3 className="font-semibold text-neutral-500 text-sm mb-2">Fecha y Hora</h3>
